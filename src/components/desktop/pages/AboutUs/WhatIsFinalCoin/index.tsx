...
//import './styles.css'
import './styless.css'
import Info from '../../../../../assets/img/infografico-finalcoin.png'
  ...
  return (
    <div className="container-what-is-final" id="what-is-final">
      ...
      <section>
        ...
        <article>
          <p>
            Peer 2 Peer transactions<br/>
            Decentralized<br/> 
            Automated wallet backups<br/>
            Investment opportunity<br/>
            Payment solution<br/>
            Safe & secure transaction<br/>
            Privacy
        </p>
          <img src={Info} alt="" />
          <p>
            Chain Anti-stall<br/>
            51% attack resistant (almost to 100%)<br/>
            Not SHA256 dependent<br/>
            Selfish mining resistant<br/>
            Timewarp resistant<br/>
            Scalable<br/>
